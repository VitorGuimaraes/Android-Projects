...
public class ColorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Create arrays
        String colors[] = new String[]{"red", "green", "brown", "gray",
                "black", "white", "dusty yellow", "mustard yellow"};
        String miwokColors[] = new String[]{"weṭeṭṭi", "chokokki", "ṭakaakki", "ṭopoppi",
                "kululli", "kelelli", "ṭopiisә", "chiwiiṭә"};
        int img[] = new int[]{R.drawable.color_red, R.drawable.color_green, R.drawable.color_brown, R.drawable.color_gray,
                R.drawable.color_black, R.drawable.color_white, R.drawable.color_dusty_yellow, R.drawable.color_mustard_yellow};
        int raw[] = new int[]{R.raw.color_red, R.raw.color_green, R.raw.color_brown, R.raw.color_gray, R.raw.color_black,
                R.raw.color_white, R.raw.color_dusty_yellow, R.raw.color_mustard_yellow};

        final ArrayList<Word> words = new ArrayList<Word>();
        int x = colors.length;

        //Add the colors to ArrayList
        for (int i = 0; i < x; i++) {
            //Create Word object and pass parameters
            words.add(new Word(colors[i], miwokColors[i], img[i], raw[i]));
        }
